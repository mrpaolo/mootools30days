...
<ol>
<li>Download the <a href="http://web.archive.org/web/20090210035054/http://mootools.net/download">Mootools 1.2 Core</a> library</li>
<li>Upload the Mootools 1.2 Core library to your server or workspace</li>
<li>Link to the Mootools 1.2 Core library in your head tag - &lt;script src=&#8221;mootools1.2core.js&#8221; type=&#8221;text/javascript&#8221;&gt;</li>
...
<div class="wp_syntax"><div class="code"><pre>&lt;script type=&quot;text/javascript&quot;&gt;&lt;!--mce:0--&gt;&lt;/script&gt;</pre></div></div>

<p>2. Create an external JavaScript file and link to it in your head:</p>

<div class="wp_syntax"><div class="code"><pre>&lt;script src=&quot;myJavaScriptFile.js&quot; type=&quot;text/javascript&quot;&gt;&lt;!--mce:1--&gt;&lt;/script&gt;</pre></div></div>
...
<div class="wp_syntax"><div class="code"><pre class="javascript"><span style="color: #003366; font-weight: bold;">var</span> exampleFunction <span style="color: #339933;">=</span> <span style="color: #003366; font-weight: bold;">function</span><span style="color: #009900;">&#40;</span><span style="color: #009900;">&#41;</span> <span style="color: #009900;">&#123;</span>
...
<li>Lets you easily detect <a href="http://web.archive.org/web/20090210035054/http://docs.mootools.net/Core/Browser">browsers, browser engines and browser capabilities</a></li>
</ul>
<h4>Native</h4>
...
<h3>To Learn More&#8230;</h3>
<h4><a href="http://web.archive.org/web/20090210035054/http://www.consideropen.com/downloads/30days_of_moo/mootorial_day1.zip">A zip with everything you need to get started</a></h4>
...
<p>In the mean time, here is a list of some other <a href="http://web.archive.org/web/20090210035054/http://github.com/mootools/mootools-core/wikis/mootools-tutorials">Mootorials to help you get started</a>.</p>
<h4>30 Days of Mootools Translations</h4>

<p>Hablas Español? Echa un vistazo a la traducción de <a href="http://web.archive.org/web/20090210035054/http://www.alainalemany.com/2008/10/10/30-dias-de-mootools-12-indice/">alainalemany.com</a></p>
<p>French translation: <a href="http://web.archive.org/web/20090210035054/http://www.6ma.fr/tuto/mootools+jours+jour+1+introduction-458" target="_blank">http://www.6ma.fr/tuto/mootools+jours+jour+1+introduction-458</a></p>
<p>Chinese translation: <a href="http://web.archive.org/web/20090210035054/http://ooboy.net/blog/article/605.aspx" target="_blank">http://ooboy.net/blog/article/605.aspx</a></p>
<h4>Mootools 1.2 Cheat Sheet</h4>
<p>Here is a great summary of the capabilities of Mootools 1.2.  I just printed out myself a copy and am currently looking for a place to hang it.  Maybe i&#8217;ll drop by the printers and have them set me up with a poster size :).  Anyhow, here&#8217;s the link to the <a href="http://web.archive.org/web/20090210035054/http://mediavrog.net/blog/wp-content/uploads/2008/06/mootools-12-cheat-sheet.pdf">Mootools 1.2 Cheat Sheet</a></p>
<h4>Mootools Forum</h4>

<p>If you want to chat with other folks about Mootools, check out code samples or dig into specific questions, this is the place for you.  It&#8217;s still very new, but picking up steam: <a href="http://web.archive.org/web/20090210035054/http://www.mooforum.net/">Mootools 1.2 forum</a></p>
<h4>Tomorrow</h4>
<p>Visit our <a href="http://web.archive.org/web/20090210035054/http://www.consideropen.com/blog/2008/08/30-days-of-mootools-12-tutorials-day-2-selectors/">Day 2 tutorial to learn more about Mootools 1.2 selectors</a></p>