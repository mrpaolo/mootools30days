...
<p>Welcome back to 30 days of Mootools 1.2 tutorials.  If you haven&#8217;t already, be sure to check out <a href="index.php?day=01">the rest of our mootools series</a>.  Today, we are going to take a look at the Fx.Elements plugin, which is basically an extension of Fx.Morph.  Instead of applying to a single element, Fx.Elements allows you to add the Fx functionality to multiple dom elements in one go. This can be very useful when you are applying the same options to more than one element, as we saw in <a href="index.php?day=20">the final example on day 20</a>.</p>
...
<p>Just like Fx.Morph, Fx.Elements extends the Fx class, giving you access to all <a href="index.php?day=11">the Fx options and events.</a></p>
...
<p><a href="index.php?day=23">Fx.Slide</a></p>				